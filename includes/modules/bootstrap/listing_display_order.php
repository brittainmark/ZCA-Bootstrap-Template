...
// MJFB Start sort sold to end then if master category.
switch ((int)$_GET['disp_order']) {
    ...
    case 7:
        ...
        break;
    case 8:
        $order_by = $default_sort_order ??  " ORDER BY p.products_sort_order, IF (p.products_quantity = 0, 1, 0) ASC, IF (p.master_categories_id = $current_category_id, 0, 1) ASC, pd.products_name ";
        break;
    case 0:
        // reset
        $_GET['disp_order'] = $disp_order_default;
